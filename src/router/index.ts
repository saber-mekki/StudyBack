...
import backupLinksRouter from "./backupLinks";
...
export default (app: Application) => {
  ...
  app.use("/api/v1/", [backupLinksRouter,announcements,users,courses,upload,liveSession,images,studenBooking,tutorAvailability,notification,Blog,Groups,rating,messages,purchases]);
};
